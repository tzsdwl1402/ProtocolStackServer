...
public class JsonKeyword {
    ...
    public static final String IMPROVE_PERSONAL_INFO="improvePersonalInfo";
    ...
    public static final String DELETE_FRIENDS="deleteFriends";
    ...
    //APP DETAIL INFO
    public static final String APP_DETAIL_INFO="appDetailInfo";
